        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item menu-closed">
            ...
            <ul class="nav nav-treeview">
                <li class="nav-item">
                  <a href="{{route('jumbotron')}}" class="nav-link active">
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Jumbotron Page</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
                                    ...
                                    <form action="{{route('JumbotronUpdate', ['id' => $item->id])}}" method="POST" enctype="multipart/form-data"> 
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" id="title" placeholder="" name="vslogan" value="{{ $item->slogan }}">
                                                    @error('vslogan')
                                                    <small>{{ $message }}</small>
                                                    @enderror
                                            </div>
                                            <div class="form-group">
                                                ...
                                                <textarea name="vdeskripsi" id="content" class="form-control">{{ $item->deskripsi }}</textarea>
                                                    @error('vdescription')
                                                    <small>{{ $message }}</small>
                                                    @enderror
                                            </div>

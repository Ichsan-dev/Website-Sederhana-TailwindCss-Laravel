                    ...
                    @foreach ($getService as $item)                          
                      <tr>
                        ...
                        <td>{{$item->deskripsi}}</td>
                         <td style="text-align: center"><img src="{{asset('storage/service/'.$item->image)}}" alt="" width="70px"></td>
                        ...
                        <div class="modal fade" id="modal-edit{{$item->id}}">
                            <div class="modal-dialog">
                              <div class="modal-content">
                                    ...
                                    <form action="{{route('ServiceUpdate', ['id' => $item->id])}}" method="POST" enctype="multipart/form-data"> 
                                            @csrf
                                            @method('PUT')
                                        <div class="modal-body">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" id="title" placeholder="" name="vdeskripsi" value="{{ $item->deskripsi }}">
                                                    @error('vdeskripsi')
                                                    <small>{{ $message }}</small>
                                                    @enderror
                                            </div>
                                             <div class="form-group">
                                                  ...
                                                  <img src="{{ asset('storage/service/'.$item->image)}}" alt="Current Image" style="max-width: 200px;">
                                              </div>
